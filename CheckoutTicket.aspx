<%@ Page Title="Buy Ticket Checkout" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="CheckoutTicket.aspx.cs" Inherits="ReaVaya_Bus_System.CheckoutTicket" %>
            ...
            <section>
                <div class="card">
                    ...
                    <div class="notification-item">
                        <div class="card-body">
                            <h5 class="card-title">Checkout: Ticket Purchase</h5>
     ...
     <asp:DropDownList ID="existingCard" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ExistingCard_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <div class="notification-item">
                        <div class="card-body">
                            ...
                            <div class="form-group text-center">
                                <asp:Button ID="EPaybtn" CssClass="btn btn-primary" runat="server" Text="Pay" OnClick="EPaybtn_Click1" />
</div>
