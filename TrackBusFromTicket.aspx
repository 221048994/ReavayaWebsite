<%@ Page Title="Track Bus" Language="C#" MasterPageFile="~/dashboard.Master" AutoEventWireup="true" CodeBehind="TrackBusFromTicket.aspx.cs" Inherits="ReaVaya_Bus_System.TrackBusFromTicket" %>
...
<div class="card">
    ...
    <div id="notification-item">
        <div id="input-container"  style=" margin-left: 200px;">
            <label for="origin">Station from:</label>
            <asp:Label ID="originn" runat="server"  ForeColor="#FF3300"></asp:Label>

            <label for="destination">Station to:</label>
            <asp:Label ID="destinationn" runat="server" ForeColor="#FF3300"></asp:Label>
            <hr>
            <div>
...
<script>
    ...
    var reaVayaBuses = [
        { id: "Bus1", name: "", location: { lat: -26.2043, lng: 28.0456 } },
        { id: "Bus2", name: "", location: { lat: -26.2023, lng: 28.0406 } },
        { id: "Bus3", name: "", location: { lat: -26.2100, lng: 28.0500 } },
        { id: "Bus4", name: "", location: { lat: -26.2150, lng: 28.0550 } },
        { id: "Bus5", name: "", location: { lat: -26.2200, lng: 28.0600 } }
    ];
    ...
    function trackBus() {
        var origin = document.getElementById('<%= originn.ClientID %>').innerText;
        var destination = document.getElementById('<%= destinationn.ClientID %>').innerText;
        ...
        directionsService.route(request, function (response, status) {
            if (status === 'OK') {
                ...
                // Add selected buses to the map and show their estimated arrival times
                ...
                selectedBuses.forEach(function (bus) {
                    // Place each bus at a random location along the route
                    ...
                    listItem.innerHTML = `${bus.name} Estimated Arrival Time: Calculating...`;
                    ...
                    listItem.innerHTML = `${bus.name} Estimated Arrival Time: ${estimatedTime}`;
                });
