...
<div class="container">
        ...
        <asp:Repeater ID="TicketRepeater" runat="server">
            <ItemTemplate>
                <!-- Each ticket is inside its own independent container -->
                <div class="ticket">
                    ...
                    <div class="button-container">
                        <asp:Button ID="BoardButton" runat="server" Text="Board" CommandArgument='<%# Eval("TicketNumber") %>' OnClick="BoardButton_Click" CssClass="btn btn-primary" Enabled='<%# Eval("Status").ToString() == "Unused" %>' />
                    </div>
                </div>
                <!-- Add a horizontal line between tickets to clearly separate them -->
                <hr />
            </ItemTemplate>
        </asp:Repeater>
        <!-- Repeater ends here -->
