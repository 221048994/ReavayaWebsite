...
<body style="background: floralwhite;">
    ...
    <div class="image-container">
        <img src="images/Rea_Vaya_logo.svg.png" alt="Logo">
    </div>
    ...
    <asp:RegularExpressionValidator 
        ...
        ValidationExpression="^\d{10}$">
                        ...
                        <div class="form-group btn-box">
                            <asp:Button ID="registerBtn" CssClass="btn2" runat="server" Text="Register" OnClick="RegisterBtn_Click" style="background:blue; color:white;"/>
                        </div>
