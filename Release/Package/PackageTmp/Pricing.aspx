    ...
    <div id="map-container">
        <div id="input-container">
            ...
            <div id="price-container">
                ...
                <asp:Button ID="PurchaseBtn" runat="server" Text="Buy Ticket" CssClass="btn btn-primary" OnClientClick="purchaseTicket(); return false" />
            </div>
...
<script>
    ...
    function getRouteAndPrice() {
        ...
        directionsService.route(request, function (response, status) {
            if (status === 'OK') {
                ...
                //var distance = directionsService.distance.value / 100;
                ...
                //getPrice(distance); //  Pass the calculated distance
    ...
    function purchaseTicket() {
        var selectedOrigin = originSelect.options[originSelect.selectedIndex].text;
        var selectedDestination = destinationSelect.options[destinationSelect.selectedIndex].text;

        var purchaseUrl = `CheckoutTicket.aspx?origin=${encodeURIComponent(selectedOrigin)}&destination=${encodeURIComponent(selectedDestination)}&price=${encodeURIComponent(price.toFixed(2))}`;
